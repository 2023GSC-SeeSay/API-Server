...
var mouth_image_linux = map[string]string{
	"ㅣ": "/assets/img/mouth/ll.png",
	"ㅡ": "/assets/img/mouth/EU.png",
	"ㅏ": "/assets/img/mouth/AA.png",
	"ㅓ": "/assets/img/mouth/EO.png",
	"ㅗ": "/assets/img/mouth/OO.png",
	"ㅜ": "/assets/img/mouth/UU.png",
	"ㅔ": "/assets/img/mouth/EE.png",
	"ㅈ": "/assets/img/mouth/JY.png",
	"ㅊ": "/assets/img/mouth/WW.png",
}
var mouth_image_windows = map[string]string{
	"ㅣ": "\\assets\\img\\mouth\\ll.png",
	"ㅡ": "\\assets\\img\\mouth\\EU.png",
	"ㅏ": "\\assets\\img\\mouth\\AA.png",
	"ㅓ": "\\assets\\img\\mouth\\EO.png",
...
var tongue_image_linux = map[string]string{
	"ㄱ": "/assets/img/tongue/KNG.png",
	"ㄴ": "/assets/img/tongue/TN.png",
	"ㄷ": "/assets/img/tongue/TN.png",
	"ㄹ": "/assets/img/tongue/TN.png",
	"ㅁ": "/assets/img/tongue/PM.png",
	"ㅂ": "/assets/img/tongue/PM.png",
	"ㅅ": "/assets/img/tongue/SH.png",
	"ㅇ": "/assets/img/tongue/KNG.png",
	"ㅈ": "/assets/img/tongue/J.png",
	"ㅊ": "/assets/img/tongue/J.png",
	"ㅋ": "/assets/img/tongue/KNG.png",
	"ㅌ": "/assets/img/tongue/TN.png",
	"ㅍ": "/assets/img/tongue/PM.png",
	"ㅎ": "/assets/img/tongue/KNg.png",
	"ㄲ": "/assets/img/tongue/KNG.png",
	"ㄸ": "/assets/img/tongue/TN.png",
	"ㅃ": "/assets/img/tongue/PM.png",
	"ㅆ": "/assets/img/tongue/SH.png",
	"ㅉ": "/assets/img/tongue/J.png",
}
var tongue_image_windows = map[string]string{
	"ㄱ": "\\assets\\img\\tongue\\KNG.png",
	"ㄴ": "\\assets\\img\\tongue\\TN.png",
	"ㄷ": "\\assets\\img\\tongue\\TN.png",
	"ㄹ": "\\assets\\img\\tongue\\TN.png",
	"ㅁ": "\\assets\\img\\tongue\\PM.png",
	"ㅂ": "\\assets\\img\\tongue\\PM.png",
	"ㅅ": "\\assets\\img\\tongue\\SH.png",
	"ㅇ": "\\assets\\img\\tongue\\KNG.png",
	"ㅈ": "\\assets\\img\\tongue\\J.png",
	"ㅊ": "\\assets\\img\\tongue\\J.png",
	"ㅋ": "\\assets\\img\\tongue\\KNG.png",
	"ㅌ": "\\assets\\img\\tongue\\TN.png",
	"ㅍ": "\\assets\\img\\tongue\\PM.png",
	"ㅎ": "\\assets\\img\\tongue\\KNg.png",
	"ㄲ": "\\assets\\img\\tongue\\KNG.png",
	"ㄸ": "\\assets\\img\\tongue\\TN.png",
	"ㅃ": "\\assets\\img\\tongue\\PM.png",
	"ㅆ": "\\assets\\img\\tongue\\SH.png",
	"ㅉ": "\\assets\\img\\tongue\\J.png",
}
var mouth_seperate = map[rune]string{
	'ㅣ': "ㅣ",
	'ㅡ': "ㅡ",
	'ㅏ': "ㅏ",
	'ㅓ': "ㅓ",
