...
func GenerateGIF(pathes []GifInfo, title string) string {
	...
	palette := color.Palette{
		...
		color.RGBA{200,146,112, 0},
		color.RGBA{105,56,52, 0},
		color.RGBA{191,67,63, 0},
		color.RGBA{152,87,83, 0},
		color.RGBA{11,5,2, 0},
		color.RGBA{103,92,86, 0},
		color.RGBA{65,51,42, 0},
		color.RGBA{127,64,62, 0},
		color.RGBA{74,40,29, 0},
		color.RGBA{183,78,75, 0},
		color.RGBA{189,142,112, 0},
		color.RGBA{192,143,111, 0},
		color.RGBA{181,64,59, 0},
		color.RGBA{181,90,86, 0},
		color.RGBA{95,55,55, 0},
		color.RGBA{179,90,89, 0},
		color.RGBA{174,178,177, 0},
		color.RGBA{168,145,136, 0},
		color.RGBA{185,177,167, 0},
		color.RGBA{159,85,82, 0},
		color.RGBA{154,85,80, 0},
		color.RGBA{87,61,58, 0},
		color.RGBA{197,75,71, 0},
		color.RGBA{163,81,78, 0},
		color.RGBA{107,58,53, 0},
		color.RGBA{99,51,49, 0},
		color.RGBA{166,117,101, 0},
		color.RGBA{52,42,33, 0},
		color.RGBA{38,20,19, 0},
		color.RGBA{132,121,121, 0},
		color.RGBA{191,141,108, 0},
		color.RGBA{181,140,115, 0},
		color.RGBA{136,77,66, 0},
		color.RGBA{173,107,102, 0},
		color.RGBA{195,149,116, 0},
		color.RGBA{142,78,77, 0},
		color.RGBA{176,70,64, 0},
		color.RGBA{173,125,103, 0},
		color.RGBA{189,143,110, 0},
		color.RGBA{160,125,103, 0},
		color.RGBA{144,116,95, 0},
		color.RGBA{83,65,53, 0},
		color.RGBA{7,1,1, 0},
		color.RGBA{154,126,105, 0},
		color.RGBA{159,118,98, 0},
		color.RGBA{144,116,95, 0},
		color.RGBA{137,108,85, 0},
		color.RGBA{189,143,116, 0},
		color.RGBA{156,120,96, 0},
		color.RGBA{154,126,105, 0},
		color.RGBA{154,118,94, 0},
		color.RGBA{62,34,33, 0},
	}
